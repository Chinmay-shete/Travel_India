...
<head>
    ...
    <style>
        @font-face {
  font-family: twl;
  src: url(../assets/fonts/66bdbff11e188b5245c6ce47_TWKLausanne-400.ttf);
}
@font-face {
  font-family: regular;
  src: url(../assets/fonts/66bdbfd4186d4f1e46bc84ab_Tartuffo-Regular.ttf);
}
@font-face {
  font-family: regular2;
  src: url(../assets/fonts/66bdbfce81e82ca87a30c297_Tartuffo-Light.ttf);
}
@font-face {
  font-family: aeonik;
  src: url(../assets/fonts/66de30cc396af3b5cc39c4b6_Aeonik-Medium.woff2);
}
        html,
        body {
            width: 100%;
