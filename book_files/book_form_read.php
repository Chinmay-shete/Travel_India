...
<body>
    <div class="signUpPage">
        ...
        <div class="signUpPage-part1"> 
          ...
          <div class="container"> 
            <form id="booking-form" action="pay_now1.php?passid=<?php echo h($data['TourPackage_Id']); ?>" method="post">
              <?php echo csrf_field(); ?>
              ...
              <button class="submitButton" type="submit" name="submit">Book Now</button>
            </form>
          </div> 
        </div>
      </div>
